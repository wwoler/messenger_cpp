...
3)login принимает в качестве аргумента ссылку на объект типа User  и возвращает true, если авторизация прошла успешна, в противном случае возвращает false, используется для авторизации пользователя на основе переданных в функцию данных, если такой пользователь существует и введен правильный логин и 
