...
сущесвтует класс(Chat), который работает с пользователем(ввод/вывод данных) 
...
13)get_info выводит информацию о пользователе(логин, имя, пароль), не имеет параметров, возвращает void
