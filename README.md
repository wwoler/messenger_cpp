...
2)from_json для извлечения данных о пользователе или сообщении из файла "базы данных"
...
11)adjustment очищает данные оставшиеся от старой структуры в файле
...
9)action_for_user запрос на выбор доступных пользователю функций
...
17)set_current_user устанавливает нового авторизированного пользователя для работы с ним
